 ...
 *
 * @author Chabok Team (team@chabok.io)
 */
...
final class ChabokIO {
	...
	private function setup_constants() {
		...
		if ( ! defined( 'CHABOK_VER' ) ) {
			define( 'CHABOK_VER', '1.0.0' );
		}
		if ( ! defined( 'URL_CHABOK_API' ) ) {
			define( 'URL_CHABOK_API', 'https://push.adpdigital.com/api%s?access_token=');
		}
	...
	private function includes() {
		...
		require_once CHABOK_DIR . 'includes/woo.php';
	}
